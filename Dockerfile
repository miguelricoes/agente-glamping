    ...
    # ETAPA 11: Verificación robusta de dependencias críticas
    COPY verify_dependencies.py /tmp/
    RUN python /tmp/verify_dependencies.py
    RUN rm /tmp/verify_dependencies.py
